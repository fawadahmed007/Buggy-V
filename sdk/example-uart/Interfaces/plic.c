...
* @param irq, priority.
******************************************************************************/
void Buggyv32_Plic_Init(void)
{
  Buggyv32_Plic_Set_Priority(1, 5);
  Buggyv32_Plic_Set_Priority(2, 6);
  Buggyv32_Plic_Enable_IRQ(1);
  Buggyv32_Plic_Enable_IRQ(2);
}
...
* @param irq, priority.
******************************************************************************/
void Buggyv32_Plic_Enable_IRQ(uint32_t irq)
{
...
* @param irq, priority.
******************************************************************************/
void Buggyv32_Plic_Set_Priority(uint32_t irq, uint32_t priority)
{
...
* @param irq, priority.
******************************************************************************/
void Buggyv32_Plic_Irq_Handler(void)
{
